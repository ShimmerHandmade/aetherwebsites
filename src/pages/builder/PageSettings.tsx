        ...
        <div className="bg-white rounded-lg shadow-sm p-6">
          ...
          <Card>
            <CardHeader>
              ...
              <CardDescription>Configure settings for the current page</CardDescription>
            </CardHeader>
            <CardContent className="space-y-4">
              <p className="text-sm text-gray-500">
                Edit page details in the builder by selecting a page and customizing its properties.
              </p>
              <Button
                onClick={handleBackToBuilder}
                className="mt-4"
